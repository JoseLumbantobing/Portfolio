...
export const Data = () => {
  return (
    <div className='home__data'>
        <h1 className="home__title">Jose Tobing 
            <svg
                    width="36"
                    height="36"
                    viewBox="0 0 48 48"
        ...
        <p className='home__description'>I am an empathetic, enthusiastic, responsible and hardworking person. I can work as a team or work on my own initiative and I am passionate about building software used by other people, and want to learn new technology.</p>
